...
export default class Contacts extends Component {
  render() {
    ...
    return(
      ...
      <p>
       <a style={linkStyle} target="_blank" href="https://github.com/colot-imposter">Github</a>
        </p>
        <p>
            <a style={linkStyle} target="_blank" href="https://www.facebook.com/colton.dowling">Facebook</a>
          </p>
          <p>
